...
if(Meteor.isClient){
  ...
  Template.leaderboard.helpers({
    'player': function(){
      ...
      return PlayersList.find({createdBy: currentUserID}, // technically no longer needed, since accounts already make sure this happens!
        {sort: {score: -1, name: 1}}); // make available PlayersList to template
    ...
    'totalUserPlayers': function(){ // NOT WORKING - should return players created by user
  ...
  Template.addPlayerForm.events({
    'submit form': function(event){
      ...
      PlayersList.insert({  // inserts field into Mongo Document
        name: playerNameVar,
        score: playerScore,
